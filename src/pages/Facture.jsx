...
const Facture = () => {
  ...
  return (
    <div className="fiche-detail flex flex-col items-center bg-white h-screen font-cool">
      ...
      <div onClick={numCommande} className="payer-facture w-full absolute bottom-0 flex flex-col justify-center pt-4 pb-48 px-10 bg-orange-pale rounded-t-3xl">
      ...
      <div onClick={numCommande} className="payer-facture w-full absolute bottom-0 flex flex-row place-content-between pb-24 pt-4 px-10 bg-orange-fonce rounded-t-3xl">
        <p className="font-butler font-bold text-4xl" >Total:</p>
        <p className="font-butler font-bold text-4xl" >19,54$</p>
      </div>
      <div onClick={numCommande} className="payer-facture w-3/4 absolute bottom-0 flex justify-center py-2 px-10 bg-gris-fonce rounded-t-3xl">
        <p className="text-white font-CoolCond text-4xl" >Payer la commande</p>
      </div>
    </div>
  );
};
